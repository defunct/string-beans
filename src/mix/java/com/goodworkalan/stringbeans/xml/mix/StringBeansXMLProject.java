...
/**
 * Builds the project definition for String Beans XML.
 *
 * @author Alan Gutierrez
 */
public class StringBeansXMLProject implements ProjectModule {
    /**
     * Build the project definition for String Beans XML.
     *
     * @param builder
     *          The project builder.
     */
